...
const Blog = () => {
    return (
        <div className="bg-gray-100 text-gray-700 divide-gray-700 ">
            <div className="  p-3 space-x-1 xl:ml-6">
                <h3 className=" my-4 text-3xl font-semibold">What is the purpose of React Router?</h3>
                <p className="text-sm dark:text-gray-500">React Router is a standard library for routing in React. It enables the navigation among views of various components in a React Application, allows changing the browser URL, and keeps the UI in sync with the URL.
